...
def validate(val_loader, model, criterion, args):
    ...
    with torch.no_grad():
        ...
        for i, (images, target) in enumerate(val_loader):
            images = images.to(args.gpu, non_blocking=True) if args.gpu is not None else images
            target = target.to(args.gpu, non_blocking=True) if args.gpu is not None else target
